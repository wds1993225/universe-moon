function AppMeasurement() {
    ...
    a.jb = function () {
        if (!a.wb) {
            var c = new Date, b = r.location, d, f, e = f = d = "", g = "", m = "", k = "1.2",
                n = a.cookieWrite("s_cc", "true", 0) ? "Y" : "N", q = "", s = "";
    ...
    a.t = a.track = function (c, b) {
        var d, f = new Date, e = "s" + Math.floor(f.getTime() / 108E5) % 10 + Math.floor(1E13 * Math.random()),
            g = f.getYear(),
...
function getVid() {
    ...
    var s = this;
    /*var a = s_jt.Util.cookieRead('lvid');*/
    var a = null;
    if (!a) {
      ...
      /*  if (!s_jt.Util.cookieWrite('lvid', a, c)
        ) {
            a = ''
        }*/
    }
