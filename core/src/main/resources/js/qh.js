...
jt_c.sc = function () {
    try {
        var st = jt_c.gc("s_tagEnv");
        var st = st ? st : "live";
        var sv = "";
        var pa = "webwebfenxi.189.cn";
        var protocol = location.protocol.toLowerCase();
        sv = (protocol == "https:") ? "https://" + pa + ":9002" : "http://" + pa + ":9000";
        var d = document;
        var ist = d.createElement("script");
        var l = d.getElementsByTagName("head");
        var p = l && l[0] ? l[0] : "";
        ist.type = "text/javascript";
        var js = "sv.js?v=" + new Date().getTime();
    ...
    try {
        ...
        var l = d.getElementsByTagName("head");
        var p = l && l[0] ? l[0] : "";
        var insight_v = jt_c.gc("code_v");
        ist.type = "text/javascript";
        var js = "ct189.js.js?v=" + ("undefined" == typeof(insight_v) ? new Date().getTime() : insight_v);
        ist.src = sv + "/scode/" + st + "/" + js;
        if (p.firstChild) {
            p.insertBefore(ist, p.firstChild)
        } else {
...
function getECS_ReqInfo_login1(txtAccount) {
...
function getECS_ReqInfo_login1_BK(txtAccount, txtUType, hidUType, txtCityNo, hidProvinceID, hidAreaCode, hidCityNo, hidRandomFlag) {
...
function h(i) {
    return d(undefined ? JSON.stringify(i) : String(i))
}
